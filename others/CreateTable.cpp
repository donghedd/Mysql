...
void CreateTable() {
	...
	//创建文件夹
	//string file = "C:/mysql/files/ kk/dd";
	string file = "C:/mysql/files/"+Database +'/' + table;
	...
	//创建文件， 存放数据
	string p = "C:/mysql/files/" + Database + '/' + table + "/" + "value.txt";
	...
	//表目录
	string tfile = "C:/mysql/files/" + Database + "/" + "tables.txt";
